...
@ComponentScan(basePackages = {"com.ohgiraffers","com"}, useDefaultFilters = false,
//NOTE. 현재 설정 파일 bean 제외 나머지는 off
            includeFilters = {
                @ComponentScan.Filter(
                        type = FilterType.ASSIGNABLE_TYPE,
                        classes = {MemberDAO.class}     //NOTE. MemberDAO 타입 bean만 등록
                )
            })
