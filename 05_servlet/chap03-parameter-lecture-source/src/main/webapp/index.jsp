...
<h4>a 태그의 href 속성에 직접 파라미터를 써서 쿼리스트림을 작성하고 get요청을 할 수 있다.</h4>
<a href="querystring?name=홍길동&age=21&birthday=2018-06-24&gender=M&national=ko&hobbies=movie&hobbies=music">a태그를 활용한 쿼리스트링 방식
</a>
