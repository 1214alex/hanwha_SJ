...
public class Application2 {
    public static void main(String[] args) {
        ...
        try {
            ...
            /* 설명. PrepareStatement는 Statement와 달리 placeholder(?)를 활용해 하나의 문자열 형태로 작성이 가능하다. */
            ...
            if (rset.next()) {
                System.out.println("조회하신 사원의 사번과 이름은: " + rset.getString("EMP_ID") + ", " + rset.getString("EMP_NAME"));
            }
