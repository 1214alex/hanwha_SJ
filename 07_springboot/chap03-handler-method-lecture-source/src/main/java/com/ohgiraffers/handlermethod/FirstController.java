...
/* 설명. 이 Controller 클래스의 핸들러 메소드에서 Model에 "id"라는 키 값으로 담긴 값을 HttpSession에 추가하는 어노테이션*/
...
//    }
    ...
    /* 설명. request는 사용자의 입력값(parameter)를 담는 용도로 쓰고 Model은 백엔드에서 동적 페이지를 만들 때 사용하는 용도로 쓰자.*/
    @PostMapping("regist")
    ...
    /* 설명.
     *  request의 parameter로 넘어오는 값 들의 key값과 일치하는 변수명을 작성하고 @RequestParam
    ...
    * */
    ...
    public String modify1(Model model,@RequestParam(name = "name", defaultValue = "디폴트") String modifyName,
     ...
     *
     * 설명.
     *  @ModelAttrubute 어노테이션을 활용하면 커맨드 객체를 모델에 attribute로 담아주며 이후 view의 재료로
    ...
    * */
    ...
    public String logoutTest1(HttpSession session){
        session.invalidate();       //NOTE attribute의 값을 비우기
