...
//        int[] shapenumber = new int[]{shape.hashCode(),numbers.hashCode()};
        int randomShapeIndex = (int)(Math.random() * shape.length);
        int randomNumberIndex = (int)(Math.random() * numbers.length);

        System.out.println("당신이 뽑은 카드는 " + shape[randomShapeIndex] + " " + numbers[randomNumberIndex] + "카드 입니다.");
//        for (int i = 0; i< shapenumber.length; i++) {
//            System.out.println( shapenumber[i]);
//        }
