...
//        Subjects subject2 = new Subjects();    // 우리가 enum 타입의 생성자를 직접 사용 X
...
//        if (subject1 == subject2)              // 서로 다르다라고 뜨는 건 서로 다른 객체기 때문
        ...
        System.out.println(Subjects.JAVA.name());               // 얘는 재정의 불가.
