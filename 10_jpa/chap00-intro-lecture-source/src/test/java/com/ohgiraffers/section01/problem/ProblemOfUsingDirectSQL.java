...
public class ProblemOfUsingDirectSQL {
    ...
    void setConnection() throws ClassNotFoundException, SQLException {
        ...
        String url = "jdbc:mysql://localhost:3307/menudb";
        String user = "root";
    ...
    * */
    ...
    void testDirectSelectSql() throws SQLException {
        ...
        while(rset.next()) {
            ...
            menu.setMenuName(rset.getString("MENU_CODE"));
            menu.setMenuPrice(rset.getInt("MENU_CODE"));
            menu.setCategoryCode(rset.getInt("MENU_CODE"));
            menu.setOrderableStatus(rset.getString("MENU_CODE"));
    ...
    void testAssociationObject() throws SQLException {
        ...
        // given
        String query = "SELECT A.MENU_CODE, A.MENU_NAME, A.MENU_PRICE, B.CATEOGORY_CODE, "
        ...
        while(rset.next()) {
            ...
            menuAndCategory.setMenuCode(rset.getInt("A.MENU_CODE"));
            menuAndCategory.setMenuName(rset.getString("A.MENU_NAME"));
            menuAndCategory.setMenuPrice(rset.getInt("A.MENU_PRICE"));
