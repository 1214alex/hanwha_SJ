...
//        System.out.println("category = " + category);
        ...
        /* 설명. fetch=FetchType.LAZY로 두고 toString()에서 category 관련 코드도 주석하고 jpql을 통한 fetch join을 한다
         *      (inner join 발생으로 불필요한 조회가 없고 N+1문제를 해결할 수 있다.)
        * */
        String jpql = "select m from menu_and_category m join fetch m.category c where m.menuCode = "
                     + menuCode;
