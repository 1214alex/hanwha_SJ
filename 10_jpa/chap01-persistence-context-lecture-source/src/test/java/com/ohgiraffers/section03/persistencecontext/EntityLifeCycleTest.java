...
public class EntityLifeCycleTest {
    ...
    * */
    ...
    public void 준영속성_detach_테스트() {
         ...
         * 설명.
         *  준영속을 사용하는 이유?
         *  JAP에서 엔티티를 더 이상 영속성 컨텍스트에서 관리하지 않음을 의미하며, 특정 상황에서 성능 최적화나
...
//        entityManager.clear();      //NOTE 영속성 컨텍스트에 있는 모든 영속상태의 엔티티를 준영속 상태로 변경
        entityManager.close();        //NOTE 기존의 영속 상태의 엔티티들이 모두 준영속 상태로 변경 + 영속성 컨텍스트 파괴
        entityManager = entityManagerFactory.createEntityManager();
