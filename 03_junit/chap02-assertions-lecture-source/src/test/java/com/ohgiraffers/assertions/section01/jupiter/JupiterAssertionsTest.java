...
public class JupiterAssertionsTest {
    ...
    public void testAssertEquals() {
        ...
        /* note. 모든 테스트 케이스는 given,when,then 순으로 작성을 한다 */
...
//        Assertions.assertEquals(expected, actual, 1);   //오차범위 허용
        Assertions.assertEquals(expected, actual, "이건 정확해야 해요!");
    }
    ...
    void testAssertNotEqualsWithInstances(){
        ...
        // then
        Assertions.assertNotEquals(obj1, obj2); //note. 동등비교를 하는것이 아닌 동일성 비교
    ...
    void testAssertThrows() {
        ...
        Assertions.assertAll(
                ...
                () -> Assertions.assertEquals(expectedMessage, exception.getMessage(), () -> "예외 메시지가 일치하지 않음")
        );
